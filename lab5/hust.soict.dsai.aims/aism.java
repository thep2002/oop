...
public class aism  {
    ...
    public static void showMenu() {
        ...
        System.out.println("--------------------------------");
        System.out.println("1. View Store.store");
        System.out.println("2. Update Store.store");
            ...
            switch (option) {
                case 1:
                    ...
                    if (media != null) {
                        ...
                        System.out.println("The media is not in the Store.store");
                    }
                    break;
                case 2:
    ...
    public static void case2() throws PlayerException, LimitException {
        ...
        // the Store.store
        while (true) {
            System.out.println("You want do add or remove media from Store.store?");
